...
jsonSource_reaCosechadaenCaaPaneleraHa_2.addFeatures(features_reaCosechadaenCaaPaneleraHa_2);var lyr_reaCosechadaenCaaPaneleraHa_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/reaCosechadaenCaaPaneleraHa_2_0.png" />  14 - 63 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHa_2_1.png" />  63 - 204 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHa_2_2.png" />  204 - 1628 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHa_2_3.png" />  1628 - 3104 <br />\
    <img src="styles/legend/reaCosechadaenCaaPaneleraHa_2_4.png" />  3104 - 3827 <br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_Boyaca_1.setVisible(true);lyr_reaCosechadaenCaaPaneleraHa_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Boyaca_1,lyr_reaCosechadaenCaaPaneleraHa_2];
...
lyr_reaCosechadaenCaaPaneleraHa_2.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', 'CULTIVO': 'CULTIVO', 'AÑO': 'AÑO', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/Ha)': 'REND.(Ton/Ha)', 'No': 'No', });
...
lyr_reaCosechadaenCaaPaneleraHa_2.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'CULTIVO': 'TextEdit', 'AÑO': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/Ha)': 'TextEdit', 'No': 'Range', });
...
lyr_reaCosechadaenCaaPaneleraHa_2.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', 'CULTIVO': 'inline label', 'AÑO': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/Ha)': 'inline label', 'No': 'inline label', });
